...
if ($is_submit_form) {
    ...
    $rowcontent['audio'] = $nv_Request->get_title('audio', 'post', '');
    ...
    if (empty($error)) {
        ...
        if ($rowcontent['id'] == 0 or $copy) {
            ...
            $sql = 'INSERT INTO ' . NV_PREFIXLANG . '_' . $module_data . '_rows (
                catid, listcatid, topicid, admin_id, author, sourceid, addtime, edittime, status, weight, publtime, exptime, archive, title, alias, audio, hometext,
            ...
            $data_insert['audio'] = $rowcontent['audio'];
            ...
            $sth->bindParam(':audio', $rowcontent['audio'], PDO::PARAM_STR);
