...
<form action="#" method="post" enctype="multipart/form-data" id="form_upload_video">
    <label for="file"><span>Filename:</span></label>
    <input type="file" name="file" id="file_video_upload" accept="audio/*" /> 
    <br />
		...
		<div class="col-sm-24 col-md-18">
			<table class="table table-striped table-bordered">
				...
				<tbody>
                   ...
                   <tr>
						<td><strong>{LANG.content_audio}</strong></td>
						<td>
                            <input class="form-control" style="width:380px" type="text" name="audio" id="audio_path" value="{rowcontent.audio}"/>                           
                            <div class="rp-sprinner">
                                <input id="select-video-post" type="button" value="{GLANG.browse_audio}" name="selectvideo" class="btn btn-info" />
                                <i class="fa fa-2x text-success fa-spin fa-spinner rp-loading"></i>
                            </div>
                        </td>
					</tr>
					<tr>
